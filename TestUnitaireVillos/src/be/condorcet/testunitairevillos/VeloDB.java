package be.condorcet.testunitairevillos;
...
import be.condorcet.testunitairevillos.CRUD;
import be.condorcet.testunitairevillos.Velo;
...
public class VeloDB extends Velo implements CRUD {
	...
	public static ArrayList<VeloDB> rechVelos(int siteRech) throws Exception{ 
	    ArrayList<VeloDB> plusieurs = new ArrayList<VeloDB>();
	    String req = "select * from velo where idsite =?";
